      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="agendawrapper" id={"agendawrapper"+post_id}>
            ...
            {data.blocksdata && data.blocksdata.map((block, blockindex) => {
                ...
                {showDetails && 'wp4toastmasters/help' == block.blockName && <p>See the knowledge base article <a href="https://toastmost.org/knowledge-base/editing-agendas-and-agenda-templates-with-the-front-end-organize-screen/">Editing agendas and agenda templates with the front-end Organize screen</a> for video and written instructions.</p>}

...
} elseif ( isset( $_GET['wp4t_agenda_note'] ) ) {

	$text = sprintf( 'Note: %s Display: %s', sanitize_textarea_field($_GET['wp4t_agenda_note']), sanitize_text_field($_GET['agenda_display']) );

	$tip  = '(double-click for popup editor)';

} elseif ( isset( $_GET['wp4t_themewords'] ) ) {

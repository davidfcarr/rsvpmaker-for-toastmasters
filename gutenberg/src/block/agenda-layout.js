...
if ((typeof toastmasters_special !== 'undefined') && (toastmasters_special == 'Agenda Layout')) { // only initialize these blocks for Agenda Layout document
	registerBlockType(
		'wp4toastmasters/agenda-wrapper',
		{

...
<!-- /wp:wp4toastmasters/agendaprivacy -->' . "\n\n";
			...
			{
			$agenda_content .= '<!-- wp:wp4toastmasters/agendaedit {"time_allowed":' . $time_break . ',"uid":"note1534625016726","editable":"","defaultContent":' . wp_json_encode( $time_break . ' minute break' ) . '} /-->' . "\n\n";
			}
			...
			if ( ! empty( $_POST['reports'] ) ) {
				...
				$agenda_content .= '<!-- wp:wp4toastmasters/agendaedit {"time_allowed":' . $time_ge . ',"uid":"note1534625016726","editable":"","defaultContent":' . wp_json_encode( $content ) . '} /-->' . "\n\n";
			}
			...
			if ( ! empty( $_POST['closing'] ) ) {
				...
				$agenda_content .= '<!-- wp:wp4toastmasters/agendaedit {"time_allowed":' . $time_closing . ',"uid":"note1534625016726","editable":"","defaultContent":' . wp_json_encode( $content ) . '} /-->' . "\n\n";
			}
